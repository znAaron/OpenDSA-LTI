...
ActiveRecord::Schema.define(version: 2020_04_25_231608) do
  ...
  create_table "odsa_book_progresses", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "inst_book_id", null: false
    t.text "started_exercises", null: false
    t.text "proficient_exercises", null: false
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "odsa_user_interactions_old", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "inst_book_id"
    t.bigint "inst_section_id"
    t.bigint "inst_book_section_exercise_id"
  ...
  add_foreign_key "odsa_user_interactions_old", "inst_book_section_exercises", name: "odsa_user_interactions_inst_book_section_exercise_id_fk"
  add_foreign_key "odsa_user_interactions_old", "inst_books", name: "odsa_user_interactions_inst_book_id_fk"
  add_foreign_key "odsa_user_interactions_old", "inst_course_offering_exercises", name: "odsa_user_interactions_inst_course_offering_exercise_id_fk"
  add_foreign_key "odsa_user_interactions_old", "inst_module_section_exercises"
  add_foreign_key "odsa_user_interactions_old", "inst_module_versions"
  add_foreign_key "odsa_user_interactions_old", "inst_sections", name: "odsa_user_interactions_inst_section_id_fk"
  add_foreign_key "odsa_user_interactions_old", "users", name: "odsa_user_interactions_user_id_fk"
